...
struct Info {
	...
	Info(TASK _task = TASK::TEST, int _n = 0, int _m = 0, int _k = 0, double _epsMet = 0.0, int _Nmax = 0, double _epsN = 0.0, int _N = 0, double _norm_RN = 0.0,
		 ...
		 double _norm_RN2 = 0.0, double _norm_R02 = 0.0, double _max_x2 = 0.0, double _max_y2 = 0.0) 
		...
		norm_R0(_norm_R0), epsN2(_epsN2), eps2(_eps2), N2(_N2), norm_RN2(_norm_RN2), norm_R02(_norm_R02), max_x2(_max_x2), max_y2(_max_y2) {};
};